...
$reference_id   = $reference_id;                  // unique order id of the transaction, generated by merchant

$reference  = uniqid("PAY_".$reference_id);
...
$sql = "UPDATE transaction SET status='Paid',tracking_id=$reference WHERE id=$reference_id";

// Insert into another table
$action = "Updated role";
$sql = "INSERT INTO payments (customer_id,reference,tracking_id, created_at,updated_at) 
        VALUES ('$user_id',$reference,$reference_id, NOW(),NOW())";
