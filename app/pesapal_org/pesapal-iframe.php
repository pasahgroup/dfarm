...
// // Assuming you stored the user ID when the user logged in
...
$sql = "UPDATE transaction SET status='Paid',tracking_id='33' WHERE id=$reference_id";

// Insert into another table
$action = "Updated role";
$sql = "INSERT INTO payments (customer_id, created_at) 
        VALUES ('$user_id', NOW())";
