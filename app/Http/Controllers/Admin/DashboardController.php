  ...
  public function vendor()
    { 
        ...
        // dd('prinnt');
            ...
            return view('admin.pages.vendor_dashboard',compact('page_title','users','language','genres','movies','series','sports','livetv','transactions','daily_amount','weekly_amount','monthly_amount','yearly_amount','plan_list'));                  
    ...
    public function cache()
    {
        ...
        \Session::flash('flash_message', 'Cache cleared successfully');
