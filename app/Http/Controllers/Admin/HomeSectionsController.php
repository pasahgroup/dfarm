...
class HomeSectionsController extends MainAdminController
{
    ...
    public function list()    { 
        ...
        $data_list = HomeSections::orderBy('id')->paginate(8);
         
        return view('admin.pages.home_sections.list',compact('page_title','data_list'));
    }
    ...
    { 
        ...
        if(!empty($inputs['id'])){
         ...
         $section_slug = Str::slug($inputs['section_name'], '-',null);   
