...
class PaymentGatewayController extends MainAdminController
{
    ...
    {     
         ...
         // exit; 
          ...
          else if($post_id==11)
          {
            ...
            return view('admin.pages.gateway.coingate',compact('page_title','post_info','gateway_info'));
          }
          else if($post_id==12)
          {
          ...
          {
            $page_title='Braintree for App';

            return view('admin.pages.gateway.braintree',compact('page_title','post_info','gateway_info'));
          }
          else if($post_id==14)
          {
            $page_title='SSLCOMMERZ';

            return view('admin.pages.gateway.sslcommerz',compact('page_title','post_info','gateway_info'));
          }
          else if($post_id==15)
          {
            $page_title='CinetPay';
    ...
    public function paypal(Request $request)
    {
        ...
        $ad_obj = PaymentGateway::findOrFail($inputs['id']);
          ...
          $ad_obj->gateway_short_info = addslashes($inputs['gateway_short_info']); 
    ...
    public function coingate(Request $request)
    {
        ...
        $ad_obj = PaymentGateway::findOrFail($inputs['id']);
          ...
          $mode= $inputs['mode'];
          $coingate_api_key= $inputs['coingate_api_key'];
          $coingate_receive_currency= $inputs['coingate_receive_currency'];

          $gateway_data=json_encode(['mode' => $mode,'coingate_api_key' => $coingate_api_key,'coingate_receive_currency' => $coingate_receive_currency]);  
    ...
    public function sslcommerz(Request $request)
    {
        ...
        $ad_obj = PaymentGateway::findOrFail($inputs['id']);
          ...
          $gateway_data=json_encode(['mode' => $mode,'store_id' => $store_id,'store_password' => $store_password]);  
    ...
    public function cinetpay(Request $request)
    {
        ...
        $ad_obj = PaymentGateway::findOrFail($inputs['id']);
          ...
          $gateway_data=json_encode(['mode' => $mode,'cinetpay_api_key' => $cinetpay_api_key,'cinetpay_secret_key' => $cinetpay_secret_key,'cinetpay_site_id' => $cinetpay_site_id]);  
