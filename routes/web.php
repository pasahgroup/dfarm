...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
    ...
    Route::get('vendor', 'DashboardController@vendor');
...
Route::get('palatial', 'IndexController@index')->name('palatial');
...
Route::post('pesapal/pay', 'PesapalController@pesapal_pay');
// Route::post('/payConfirm/{x}', [PesapalController::class, 'payConfirm'])->name('payConfirm');
Route::post('/payConfirm/{X}', 'PesapalController@payConfirm')->name('payConfirm');
