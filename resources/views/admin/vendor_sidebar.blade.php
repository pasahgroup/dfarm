      ...
      <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu">
          ...
          <ul>
            ...
            <li class="has_sub"> 
              <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-users"></i><span>{{trans('words.cast_crew')}}</span><span class="menu-arrow"></span></a>
              <ul class="list-unstyled">                 
                <li class="{{classActivePath('actor')}}"><a href="{{ URL::to('admin/actor') }}" class="{{classActivePath('actor')}}"><i class="fa fa-user"></i><span>{{trans('words.actors')}}</span></a></li>
                <li class="{{classActivePath('director')}}"><a href="{{ URL::to('admin/director') }}" class="{{classActivePath('director')}}"><i class="fa fa-user"></i><span>{{trans('words.directors')}}</span></a></li>
               </ul>
            </li>
            ...
            <li class="has_sub"> 
              ...
              <ul class="list-unstyled">                 
                ...
                <li class="{{classActivePath('deleted_users')}}"><a href="{{ URL::to('admin/deleted_users') }}" class="{{classActivePath('deleted_users')}}"><i class="fa fa-users"></i><span>{{trans('words.deleted_users')}}</span></a></li>
               </ul>
            </li>
            ...
            <li class="has_sub"> 
              <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-play-circle"></i><span>{{trans('words.player_settings')}}</span><span class="menu-arrow"></span></a>
              <ul class="list-unstyled">                                 
                <li class="{{classActivePath('player_settings')}}"><a href="{{ URL::to('admin/player_settings') }}" class="{{classActivePath('player_settings')}}"><i class="fa fa-cog"></i><span>{{trans('words.settings')}}</span></a></li>
                
                <li class="{{classActivePath('player_ad_settings')}}"><a href="{{ URL::to('admin/player_ad_settings') }}" class="{{classActivePath('player_ad_settings')}}"><i class="fa fa-buysellads"></i><span>{{trans('words.player_ads')}}</span></a></li>
            ...
            <li class="has_sub"> 
              ...
              <ul class="list-unstyled">                 
                ...
                <li class="{{classActivePath('recaptcha_settings')}}"><a href="{{ URL::to('admin/recaptcha_settings') }}" class="{{classActivePath('recaptcha_settings')}}"><i class="fa fa-refresh"></i><span> {{trans('words.reCAPTCHA')}}</span></a></li>
                <li class="{{classActivePath('web_ads_settings')}}"><a href="{{ URL::to('admin/web_ads_settings') }}" class="{{classActivePath('web_ads_settings')}}"><i class="fa fa-buysellads"></i><span> {{trans('words.banner_ads')}}</span></a></li>

                <li class="{{classActivePath('site_maintenance')}}"><a href="{{ URL::to('admin/site_maintenance') }}" class="{{classActivePath('site_maintenance')}}"><i class="fa fa-wrench"></i><span> {{trans('words.site_maintenance')}}</span></a></li>
               </ul>
            </li> 
