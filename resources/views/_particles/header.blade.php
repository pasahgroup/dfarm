...
<header>
      ...
      <div class="col-3"> 
        <div class="right-sub-item-area">
          ...
          <div class="user-menu">
            ...
            <ul class="content-user">
              <li><a href="{{ URL::to('movies') }}" title="{{trans('words.dashboard_text')}}"><i class="fa fa-database"></i>{{trans('words.dashboard_text')}}</a></li>        
              ...
              <li><a href="{{ URL::to('watchlist') }}" title="{{trans('words.my_watchlist')}}"><i class="fa fa-list"></i>{{trans('words.my_watchlist')}}</a></li>
               ...
               <li><a href="{{ URL::to('payment') }}" title="{{trans('words.payment')}}"><i class="fa fa-list"></i>{{trans('words.payment')}}</a></li>
 ...
 <div class="user-menu">
            <div class="user-name">
              <span>
                    <img src="{{ URL::asset('site_assets/images/user-avatar.png') }}" alt="profile_img" title="Wawa" id="userPic">          
                 
              </span>
            Account<i class="fa fa-angle-down" id="userArrow"></i>
            </div>
   

            <ul class="content-user">

  <li><a href="{{ URL::to('login') }}" title="{{trans('words.login')}}"><i class="fa fa-sign-out-alt"></i>{{trans('words.login_text')}}</a></li>
  <li><a href="{{ URL::to('signup') }}" title="{{trans('words.signup')}}"><i class="fa fa-user"></i>{{trans('words.sign_up')}}</a></li>    
